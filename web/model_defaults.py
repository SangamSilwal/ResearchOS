...
DEFAULT_AGENT_MODELS: dict[AgentRole, tuple[LLMProvider, str]] = {
    ...
    AgentRole.architect_a:  (LLMProvider.anthropic, "claude-opus-4-8"),
    AgentRole.architect_b:  (LLMProvider.anthropic, "claude-opus-4-8"),
    ...
    AgentRole.summarizer:   (LLMProvider.anthropic, "claude-sonnet-5"),
}